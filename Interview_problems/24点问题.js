...
function get24Possibility () {
    ...
    console.log(possibleTypes.length)
    console.log(impossibleTypes.length)
    // fs.writeFileSync("./possible.txt", possibleTypes.join("\r\n"), "utf-8")
    // fs.writeFileSync("./impossible.txt", impossibleTypes.join("\r\n"), "utf-8")
    // debugger;
}
